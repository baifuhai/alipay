...
public class WXPayReport {
                    ...
                    public void run() {
                        while (true) {
                            try {
                                ...
                                // 先用 take 获取数据
                                String firstMsg = reportMsgQueue.take();//会阻塞至有消息
                                ...
                                for (int j = 0; j < remainNum; j++) {
                                    ...
                                    String msg = reportMsgQueue.take();
     ...
     */
    public void report(String uuid, long elapsedTimeMillis, String firstDomain, boolean primaryDomain, int firstConnectTimeoutMillis, int firstReadTimeoutMillis,
